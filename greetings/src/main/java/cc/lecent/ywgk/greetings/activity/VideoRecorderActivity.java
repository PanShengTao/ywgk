...
import cc.lecent.ywgk.greetings.util.Multimedia.SendView;
import cc.lecent.ywgk.greetings.util.Multimedia.VideoProgressBar;
                ...
                switch (action) {
                    ...
                    case MotionEvent.ACTION_UP:
                        if (!isCancel) {
                            ...
                            stopView(true);
                            Log.e("路径--------------->", "路径--------------->" + mediaUtils.getTargetFilePath());
...
//            Toast.makeText(VideoRecorderActivity.this, "文件以保存至：" + path, Toast.LENGTH_SHORT).show();
             ...
             * 这里写回调
             */
            EventBus.getDefault().post(new DataCorrection(401,path));
