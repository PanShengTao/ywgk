package cc.lecent.ywgk.home.nav.view;
...
import cc.lecent.ywgk.home.nav.adapter.ViewPagerAdapter;
import cc.lecent.ywgk.home.nav.constant.Anim;
import cc.lecent.ywgk.home.nav.utils.NavigationUtil;
...
public class EasyNavigationBar extends LinearLayout {
    ...
    private void initViews(Context context, AttributeSet attrs) {
        ...
        textView_ll = contentView.findViewById(R.id.textView_ll);
...
//        textView_ll.setBackgroundColor(Color.parseColor("#BEC3CA"));
        RelativeLayout.LayoutParams params1 = (RelativeLayout.LayoutParams) textView_ll.getLayoutParams();
        params1.height = (int) navigationHeight + 90;
        textView_ll.setLayoutParams(params1);
