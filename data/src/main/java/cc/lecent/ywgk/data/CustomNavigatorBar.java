    ...
    private void initOneType(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < totalAttributes; i++) {
            ...
            if (index == R.styleable.CustomNavigatorBar_leftImage) {
                ...
                leftText.setTextSize(TypedValue.COMPLEX_UNIT_PX, typedArray.getDimensionPixelSize(index, (int) sp2px(context, 16)));
                ...
                midText.setTextSize(TypedValue.COMPLEX_UNIT_PX, typedArray.getDimensionPixelSize(index, (int) sp2px(context, 18)));
                ...
                rightText.setTextSize(TypedValue.COMPLEX_UNIT_PX, typedArray.getDimensionPixelSize(index, (int) sp2px(context, 16)));
