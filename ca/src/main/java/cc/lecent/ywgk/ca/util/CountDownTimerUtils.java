...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {
        ...
        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_DIP,11);//22DIP
        mTextView.setTextColor(context.getResources().getColor(R.color.white));//
        mTextView.setBackgroundResource(R.drawable.button_click_gray); //设置按钮为灰色，这时是不能点击的
/**
 * 超链接 URLSpan
 ...
 */
    ...
    public void onFinish() {
        ...
        mTextView.setBackgroundResource(R.drawable.button_click_bule);  //还原背景色
    }
}
