...
public class UtilsDecoratione extends RecyclerView.ItemDecoration {
    ...
    public UtilsDecoratione(Context context, int orientation) {
        mDivider = ContextCompat.getDrawable(context, R.drawable.ic_launcher_two);
        setOrientation(orientation);
    }

    public UtilsDecoratione(Context context, int orientation, DividerType type) {
        switch (type) {
            case TYPE_FFFFFF:
